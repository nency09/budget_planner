...
String getChangelogString() {
  return """
    ...
    When tapping support, FinGenie Pro options highlight
    ...
    Cleaned up FinGenie Pro screen
    < 3.9.5
    ...
    < 3.8.0
    FinGenie pro background now extends past scrollable area - support for (i) over-scroll
    ...
    < 3.7.5
    FinGenie Pro banner in settings
