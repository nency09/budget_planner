...
import 'package:budget/pages/ai_insights_page.dart';
...
GlobalKey<AIInsightsPageState> aiInsightsPageStateKey = GlobalKey();
...
class PageNavigationFrameworkState extends State<PageNavigationFramework> {
  ...
  final List<Widget> pagesExtended = [
    ...
    AIInsightsPage(key: aiInsightsPageStateKey), //18
  ];
